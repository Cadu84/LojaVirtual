...
<div class="container-fluid">
	...
	<div class="row" style="margin-top: 15px;">
		...
		<h1 class="text-center">Ticket: <?php echo $ticket_compra ?></h1>
	...
	<div class="row" style="margin-top: 15px;">		
		...
		<div class="col-sm-5"><?php echo $exibeVenda['nm_Guitarra'];?></div>
		<div class="col-sm-1"><?php echo $exibeVenda['qt_guitarra'];?></div>
		<div class="col-sm-2"><?php echo number_format($exibeVenda['vl_total_item'],3,'.','.');?></div>				
	</div>	
	<?php } ?>
	
	<div class="row" style="margin-top: 15px;">
		<h2 class="text-center">Total desta compra: R$ <?php echo number_format($total,3,'.','.');?></h2>
	</div>
